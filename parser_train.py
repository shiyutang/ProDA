...
def parser_(parser):
    parser.add_argument('--root', type=str, default='/ssd2/tangshiyu/ProDA', help='root path')
    ...
    parser.add_argument('--stage', type=str, default='stage1', \
                            help='warm_up|stage1|stage2|stage3')
    parser.add_argument('--finetune', action='store_true')
    #model
    parser.add_argument('--resume_path', type=str, default='pretrained/warmup/\
                            from_gta5_to_cityscapes_on_deeplab101_best_model_warmup.pkl', 
    ...
    parser.add_argument('--path_LP', type=str, default='Pseudo/pretrain_warmup/LP0.95', \
                            help='path of probability-based PLA')
    parser.add_argument('--path_soft', type=str, default='Pseudo/pretrain_warmup_soft/LP0.0',\
                             help='soft pseudo label for rectification')
    parser.add_argument("--train_thred", default=0, type=float)
    parser.add_argument('--used_save_pseudo', action='store_true', \
                            help='if True used saved pseudo label')
    ...
    parser.add_argument('--adv', type=float, default=0.01, \
                            help='loss weight of adv loss, only use when stage=warm_up')
    parser.add_argument('--S_pseudo_src', type=float, default=0.0, \
                            help='loss weight of pseudo label for strong augmentation of source')
    parser.add_argument("--rce", action='store_true', \
                            help="if true, use symmetry cross entropy loss")
    parser.add_argument("--rce_alpha", default=0.1, type=float, \
                            help="loss weight for symmetry cross entropy loss")
    parser.add_argument("--rce_beta", default=1.0, type=float, \
                            help="loss weight for symmetry cross entropy loss")
    parser.add_argument("--regular_w", default=0, type=float, \
                            help='loss weight for regular term')
    parser.add_argument("--regular_type", default='MRKLD', type=str, \
                            help='MRENT|MRKLD')
    parser.add_argument('--proto_consistW', type=float, default=1.0, \
                            help='loss weight for proto_consist')
    parser.add_argument("--distillation", default=0, type=float, help="kl loss weight")

    parser.add_argument('--S_pseudo', type=float, default=0.0, \
                            help='loss weight of pseudo label for strong augmentation')
